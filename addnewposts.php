...
confirm_login();
 ...
 if (isset($_POST['Submit'])) {
   ...
   if (empty($title)) {
     ...
     $sql .= "VALUES(:dateTime,:postTitle,:categoryName,:adminName,:imageName, :postDescription)";    // dummy variable to prevent sql injection
            ...
            <div class="card bg-secondary text-light mb-3">
              <div class="card-body bg-dark">
                ...
                <div class="form-group">
                  ...
                  <textarea name="PostDescription" rows="8" cols="80" class="form-control" id="PostDescription"></textarea>
                </div>
                <div class="row">
